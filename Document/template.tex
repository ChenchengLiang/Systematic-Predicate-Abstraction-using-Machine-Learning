...
$V_{Vri}$ & Variable node                    & $Arg_{k}$(argument),$FV_{k}$ (free variable)    &  $v_{OP}$, $v_{Vri}$,  $v_{C}$,$he_{DF}$ & $he_{DF}$,$v_{OP}$\\
