...
For a single instance, the inputs are a list of templates $T_{0},T_{1},...,T_{n}$ in the form of text stream and graph and a program $P$ in the form of text stream and graph. The output is a list of templates with 0 or 1 labels $T_{0}^{l},T_{1}^{l},...,T_{n}^{l}, l= 0$ or $1$. A concrete example for an output is $T_{0}^{1} = ("inv\_main8:VerifHintInitPred(((\_0 + -1 * \_2) >= 0))",1)$
