  ...
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Bool) (F Bool) (G Bool) (H Bool) (I Bool) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Int) (S Int) (T Int) (U Int) (V Int) (W Int) (X Bool) ) 
    (=>
      ...
      (a!12 (and (not I)
                 ...
                 (= U T)
                 (= W V))))
  (and (or (not A) B C (not D) (not X) a!1 (not (<= M 0)))
       (or (not A)
           B
           C
           (not D)
       ...
       (or (not A)
           ...
           (and I
                ...
                (= W V))
           (not (<= W K)))
       (or (not A) (not B) C (not D) X a!2 (not (<= M 0)))
       (or (not A)
           (not B)
           C
           (not D)
       ...
       (or (not A)
           ...
           (and (not I)
                ...
                (= U T)
                (= W V)))
       (or A (not B) C (not D) X a!4)
       (or (not A) B C D X a!5)
       (or A (not B) (not C) D (not X) a!6)
       (or A B (not C) D (not X) a!7)
       (or A (not B) C D (not X) a!8)
       (or A (not B) (not C) D X a!9)
       (or A B (not C) (not D) X a!10)
       (or A (not B) C D X a!11)
       (or A (not B) (not C) (not D) (not X) a!1)
       (or (not A)
           B
           (not C)
           (not D)
