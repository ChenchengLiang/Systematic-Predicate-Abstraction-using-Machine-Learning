      ...
      (and
        (let ((a!1 (= (or (and (not C)
                  ...
                  (and C
                       ...
                       (not N)))
              O))
      (a!2 (= (or (not J2) (not (<= 1 O2)) (not (<= 1 Q2))) S2))
      (a!3 (= A (and O (not (<= O3 0))))))
  (and (= B1 0)
       (= B1 C1)
       (= A1 Q2)
       (= Z 0)
    ...
    (=>
      ...
      (a!2 (= (or (and (not I4)
                  ...
                  (and I4
                       ...
                       (not T4)))
              U4))
      (a!3 (= (or (not J2) (not (<= 1 O2)) (not (<= 1 Q2))) S2))
      (a!4 (= (or (not P6) (not (<= 1 U6)) (not (<= 1 W6))) Y6))
      (a!5 (and (<= 1 T) (= V 0) (= Y 0) (= A1 0) (= C1 0)))
      (a!6 (and (<= 1 T) (<= 1 (+ V Y A1 C1))))
      (a!7 (or B (and U4 (not (<= U7 0)))))
      (a!8 (or (not E8) (= (+ C1 (* (- 1) R5)) 1)))
      (a!9 (or (not E8) (= (+ V (* (- 1) Q5)) (- 1))))
      (a!10 (or (not D8) (= (+ V (* (- 1) L5)) (- 1))))
      (a!11 (or (not C8) (= (+ V (* (- 1) P7)) (- 1))))
      (a!12 (or (not B8) (= (+ Y A1 (* (- 1) T7)) 1)))
      (a!13 (or (not A8) (= (+ V (* (- 1) N7)) (- 1))))
      (a!14 (or (not A8) (= (+ T (* (- 1) O7)) 1)))
      (a!15 (or (not G8) (= (+ C1 (* (- 1) H6)) (- 1))))
      (a!16 (or (not G8) (= (+ T (* (- 1) I6)) 1)))
      (a!17 (or (not F8) (= (+ A1 C1 (* (- 1) Y5)) (- 1))))
      (a!18 (or (not F8) (= (+ V Y (* (- 1) V5)) 0)))
      (a!19 (or (not F8) (= (+ T (* (- 1) D6)) 1)))
      (a!20 (or (not Z7) (= (+ V Y A1 C1 (* (- 1) H7)) 0)))
      (a!21 (or (not Z7) (= (+ T (* (- 1) K7)) 1)))
      (a!22 (or (not Y7) (= (+ V (* (- 1) H8)) 1)))
      (a!23 (or (not Y7) (= (+ T (* (- 1) Q6)) (- 1))))
      (a!24 (or (not X7) (= (+ A1 (* (- 1) J8)) 1)))
      (a!25 (or (not X7) (= (+ T (* (- 1) N6)) (- 1))))
      (a!26 (or (not W7) (= (+ Y (* (- 1) I8)) 1)))
      (a!27 (or (not W7) (= (+ T (* (- 1) K6)) (- 1))))
      (a!28 (or (not V7) (= (+ C1 (* (- 1) K8)) 1)))
      (a!29 (or (not V7) (= (+ T (* (- 1) L8)) (- 1)))))
  (and (= B1 C1)
       (= A1 Q2)
       (= Z A1)
       (= Y P2)
