...
from utils import plot_scatter,generate_horn_graph,wrapped_generate_horn_graph,get_solvability_and_measurement_from_eldarica,get_recall_scatter
import os
...
def main():
    ...
    #predict_label(benchmark, max_nodes_per_batch, benchmark_fold, filtered_file_list,trained_model_path)#file_list


    # description: get solvability and measurement info with different predicate setting for unseen data
    get_solvability_and_measurement_from_eldarica(filtered_file_list, thread_number, continuous_extracting=continuous_extracting,
                                                  move_file=move_file)
...
def predict_label(benchmark,max_nodes_per_batch,benchmark_fold,file_list,trained_model_path):
