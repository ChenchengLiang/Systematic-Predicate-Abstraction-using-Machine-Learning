    ...
    for trained_model_path,hyper_parameters in zip(trained_model_path_list,hyper_parameters_list):
        for label in label_list:
            for benchmark_fold in benchmark_fold_list:
                wrapped_prediction(trained_model_path,benchmark,benchmark_fold,label,force_read,form_label,json_type,graph_type,gathered_nodes_binary_classification_task,hyper_parameters)
