...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int)) (or (not (and (inv_main7 var1 var2 var3 var0) (and (and (<= 0 (+ var3 (- 1))) (= (+ var3 (- 1)) var5)) (= (+ var0 1) var4)))) (inv_main7 var1 var2 var5 var4))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int)) (or (not (and (inv_main8 var1 var2 var3 var0) (and (and (<= 0 (+ var3 (- 1))) (= (+ var3 (- 1)) var5)) (= (+ var0 (- 1)) var4)))) (inv_main8 var1 var2 var5 var4))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int) (var6 Int)) (or (not (and (inv_main6 var4 var5 var0 var1 var6) (and (and (and (<= 0 (+ var4 (- 1))) (<= 0 (+ var0 (- 1)))) (= (+ var0 (- 1)) var3)) (= (+ var6 1) var2)))) (inv_main6 var4 var5 var3 var1 var2))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int) (var6 Int)) (or (not (and (inv_main6 var4 var5 var0 var1 var6) (and (and (and (not (<= 0 (+ var4 (- 1)))) (<= 0 (+ var0 (- 1)))) (= (+ var0 (- 1)) var2)) (= (+ var6 (- 1)) var3)))) (inv_main6 var4 var5 var2 var1 var3))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int)) (or (not (and (and (<= 0 (+ var1 (- 1))) (= var3 var2)) (= 0 var0))) (inv_main7 var1 var2 var3 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int)) (or (not (and (and (not (<= 0 (+ var1 (- 1)))) (= var3 var2)) (= 0 var0))) (inv_main8 var1 var2 var3 var0))))
