...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (or (not (and (inv_main7 var4 var1) (and (and (and (<= 0 (+ (+ 100 (* (- 1) var1)) (- 1))) (= (+ var4 2) var0)) (= (+ var1 1) var2)) (= var3 100)))) (inv_main7 var0 var2))))
