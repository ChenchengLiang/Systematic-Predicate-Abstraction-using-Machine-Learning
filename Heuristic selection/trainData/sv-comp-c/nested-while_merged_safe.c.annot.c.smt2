...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int) (var6 Int)) (or (not (and (inv_main11 var4 var6 var1 var0 var3) (and (and (<= 0 (+ (+ var3 (* (- 1) var6)) (- 1))) (= (+ (+ var6 2) (- 1)) var2)) (= (+ var0 1) var5)))) (inv_main11 var4 var2 var1 var5 var3))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int) (var6 Int) (var7 Int)) (or (not (and (inv_main19 var4 var7 var3 var0 var5 var1) (and (and (<= 0 (+ (+ var1 (* (- 1) var3)) (- 1))) (= (+ var3 1) var2)) (= (+ var5 1) var6)))) (inv_main19 var4 var7 var2 var0 var6 var1))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int) (var6 Int)) (or (not (and (inv_main11 var3 var6 var1 var0 var2) (and (and (and (<= 0 (+ (+ var6 (* (- 1) var2)) (- 1))) (not (<= 0 (+ (+ var2 (* (- 1) var6)) (- 1))))) (= (+ (+ var0 (- 2)) 1) var4)) (= (+ var2 1) var5)))) (inv_main10 var3 var6 var1 var4 var5))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int) (var6 Int) (var7 Int)) (or (not (and (inv_main19 var5 var7 var4 var0 var6 var1) (and (and (and (<= 0 (+ (+ var4 (* (- 1) var1)) (- 1))) (not (<= 0 (+ (+ var1 (* (- 1) var4)) (- 1))))) (= (+ var6 (- 1)) var3)) (= (+ var1 1) var2)))) (inv_main19 var5 var7 var4 var0 var3 var2))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int)) (or (not (and (and (not (<= 0 (+ var2 (- 1)))) (= var1 var2)) (= var0 var3))) (inv_main6 var2 var1 var3 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (or (not (and (and (and (<= 0 (+ var3 (- 1))) (= (+ (+ var2 (- 2)) 1) var4)) (= var1 var3)) (= 1 var0))) (inv_main10 var3 var1 var2 var4 var0))))
