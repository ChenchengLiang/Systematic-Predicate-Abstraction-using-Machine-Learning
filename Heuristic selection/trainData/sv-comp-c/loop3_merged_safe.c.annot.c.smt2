...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int)) (or (not (and (and (and (and (and (<= 0 (+ (+ 1 (* (- 1) var3)) (- 1))) (= 1 var1)) (= 1 var0)) (= 0 var5)) (= 1 var4)) (= 2 var2))) (inv_main8 var1 var0 var5))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int) (var6 Int)) (or (not (and (inv_main8 var3 var0 var2) (and (and (and (and (<= 0 (+ var3 (* (- 1) var0))) (= (+ var0 1) var5)) (= (+ var2 2) var6)) (= var4 1)) (= var1 2)))) (inv_main8 var3 var5 var6))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Int) (var6 Int)) (or (not (and (inv_main8 var2 var0 var6) (and (and (and (and (and (<= 0 (+ (+ var2 (* (- 1) var3)) (- 1))) (not (<= 0 (+ var2 (* (- 1) var0))))) (= var3 1)) (= var1 2)) (= (+ var3 1) var4)) (= (+ var1 2) var5)))) (inv_main18 var2 var6 var4 var5))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int)) (not (and (inv_main8 var2 var0 var1) (and (not (= (+ (+ var1 2) (* (- 2) var0)) 0)) (<= 0 (+ var2 (* (- 1) var0))))))))
