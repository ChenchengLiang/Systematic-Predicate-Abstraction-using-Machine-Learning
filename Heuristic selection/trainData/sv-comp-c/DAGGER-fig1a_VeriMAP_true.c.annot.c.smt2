...
(assert (forall ((var0 Int) (var1 Int)) (or (not (and (= 0 var1) (= 0 var0))) (inv_main5 var1 var0))))
(assert (forall ((var0 Int) (var1 Int)) (or (not (inv_main5 var1 var0)) (inv_main6 var1 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (or (not (and (inv_main5 var3 var1) (and (and (not (= var0 0)) (= (+ var3 1) var2)) (= (+ var1 1) var4)))) (inv_main5 var2 var4))))
