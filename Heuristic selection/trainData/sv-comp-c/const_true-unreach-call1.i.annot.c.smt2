...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int)) (or (not (and (and (and (<= 0 var3) (<= 0 var2)) (<= 0 var1)) (<= 0 var0))) (or (not (and (inv_main4 var3 var2) (and (and (<= 0 (+ (+ 1024 (* (- 1) var2)) (- 1))) (= 0 var0)) (= (+ var2 1) var1)))) (inv_main4 var0 var1)))))
