...
{ int /*@  predicates{s__info_callback!=0,s__info_callback!=1,s__info_callback==0,s__info_callback==1} @*/ s__info_callback = __VERIFIER_nondet_int();
  ...
  int /*@  predicates{s__wbio!=0,s__wbio!=1,s__wbio==0,s__wbio==1} @*/ s__wbio = __VERIFIER_nondet_int();
  ...
  int /*@  predicates{s__s3__tmp__new_cipher__algorithms!=0,s__s3__tmp__new_cipher__algorithms!=1,s__s3__tmp__new_cipher__algorithms==0,s__s3__tmp__new_cipher__algorithms==1} @*/ s__s3__tmp__new_cipher__algorithms = __VERIFIER_nondet_int();
  ...
  int /*@  predicates{__cil_tmp56==0} @*/ __cil_tmp56 ;
...
int main(void)
{ int /*@  predicates{s==12292,s==16384,s==20480,s==3,s==4096,s==4099,s==4352,s==4368,s==4369,s==4384,s==4385,s==4400,s==4401,s==4416,s==4417,s==4432,s==4433,s==4448,s==4449,s==4464,s==4465,s==4466,s==4467,s==4480,s==4481,s==4496,s==4497,s==4512,s==4513,s==4528,s==4529,s==4560,s==4561} @*/ s ;
