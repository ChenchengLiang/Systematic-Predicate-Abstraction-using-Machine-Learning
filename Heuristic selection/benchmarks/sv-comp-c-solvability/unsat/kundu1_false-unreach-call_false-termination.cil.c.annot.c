...
int /*@  predicates{e==1} @*/ e ;
int /*@  predicates{timer==0,timer==1} @*/ timer ;
char /*@  predicates{data_0=='A'} @*/ data_0 ;
char /*@  predicates{data_1=='A'} @*/ data_1 ;
char read_data(int /*@  predicates{i___0==0,i___0==1} @*/ i___0)
{ char c ;
  char /*@  predicates{__retres3=='A'} @*/ __retres3 ;
...
void write_data(int /*@  predicates{i___0==0,i___0==1} @*/ i___0 , char /*@  predicates{c=='A'} @*/ c)
{
