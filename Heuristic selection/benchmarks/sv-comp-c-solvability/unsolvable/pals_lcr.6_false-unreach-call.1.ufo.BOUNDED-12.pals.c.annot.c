...
char nomsg =(char)-1;
char /*@  predicates{r1<6,r1==0,r1>=6} @*/ r1 ;
int p1 ;
...
char /*@  predicates{((((((st1+st2)+st3)+st4)+st5)+st6)<=1),((((((st1+st2)+st3)+st4)+st5)+st6)==0),((((((st1+st2)+st3)+st4)+st5)+st6)==1),st6!=(-1),st6!=0,st6==(-1),st6==0,st6==1} @*/ st6 ;
char send6 ;
int mode6 ;
void node1(void)
{
