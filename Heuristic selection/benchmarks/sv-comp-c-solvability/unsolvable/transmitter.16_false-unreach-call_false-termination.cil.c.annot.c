...
int /*@  predicates{t10_pc==0,t10_pc==1} @*/ t10_pc = 0;
int /*@  predicates{t11_pc==0,t11_pc==1} @*/ t11_pc = 0;
int /*@  predicates{t12_pc==0,t12_pc==1} @*/ t12_pc = 0;
int /*@  predicates{t13_pc==0,t13_pc==1} @*/ t13_pc = 0;
int /*@  predicates{t14_pc==0,t14_pc==1} @*/ t14_pc = 0;
...
int /*@  predicates{t10_st==0,t10_st==1,t10_st==2} @*/ t10_st ;
int /*@  predicates{t11_st==0,t11_st==1,t11_st==2} @*/ t11_st ;
int /*@  predicates{t12_st==0,t12_st==1,t12_st==2} @*/ t12_st ;
int /*@  predicates{t13_st==0,t13_st==1,t13_st==2} @*/ t13_st ;
int /*@  predicates{t14_st==0,t14_st==1,t14_st==2} @*/ t14_st ;
...
int /*@  predicates{t10_i==1} @*/ t10_i ;
int /*@  predicates{t11_i==1} @*/ t11_i ;
int /*@  predicates{t12_i==1} @*/ t12_i ;
int /*@  predicates{t13_i==1} @*/ t13_i ;
int /*@  predicates{t14_i==1} @*/ t14_i ;
...
int /*@  predicates{T10_E==0,T10_E==1,T10_E==2} @*/ T10_E = 2;
int /*@  predicates{T11_E==0,T11_E==1,T11_E==2} @*/ T11_E = 2;
int /*@  predicates{T12_E==0,T12_E==1,T12_E==2} @*/ T12_E = 2;
int /*@  predicates{T13_E==0,T13_E==1,T13_E==2} @*/ T13_E = 2;
int /*@  predicates{T14_E==0,T14_E==1,T14_E==2} @*/ T14_E = 2;
...
int /*@  predicates{E_10==0,E_10==1,E_10==2} @*/ E_10 = 2;
int /*@  predicates{E_11==0,E_11==1,E_11==2} @*/ E_11 = 2;
int /*@  predicates{E_12==0,E_12==1,E_12==2} @*/ E_12 = 2;
int /*@  predicates{E_13==0,E_13==1,E_13==2} @*/ E_13 = 2;
int /*@  predicates{E_14==0,E_14==1,E_14==2} @*/ E_14 = 2;
...
assert(0);
    ...
    if(t10_st == 0){
      int /*@  predicates{tmp_ndt_11!=0,tmp_ndt_11==0} @*/ tmp_ndt_11;
    ...
    if(t11_st == 0){
      int /*@  predicates{tmp_ndt_12!=0,tmp_ndt_12==0} @*/ tmp_ndt_12;
    ...
    if(t12_st == 0){
      int /*@  predicates{tmp_ndt_13!=0,tmp_ndt_13==0} @*/ tmp_ndt_13;
    ...
    if(t13_st == 0){
      int /*@  predicates{tmp_ndt_14!=0,tmp_ndt_14==0} @*/ tmp_ndt_14;
    ...
    if(t14_st == 0){
      int /*@  predicates{tmp_ndt_15!=0,tmp_ndt_15==0} @*/ tmp_ndt_15;
