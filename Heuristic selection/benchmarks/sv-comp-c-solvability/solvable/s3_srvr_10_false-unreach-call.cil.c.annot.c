...
{ int /*@  predicates{s__info_callback!=0,s__info_callback!=2,s__info_callback==0,s__info_callback==2} @*/ s__info_callback = __VERIFIER_nondet_int();
  ...
  int /*@  predicates{s__s3__tmp__new_cipher__algorithms==0} @*/ s__s3__tmp__new_cipher__algorithms ;
  ...
  int /*@  predicates{buf!=0,buf!=2,buf==0,buf==2,buf==s__init_buf___0} @*/ buf = __VERIFIER_nondet_int();
  unsigned long l ;
  unsigned long Time ;
  ...
  int /*@  predicates{tmp___3!=0,tmp___3!=2,tmp___3==0,tmp___3==2} @*/ tmp___3 ;
  int /*@  predicates{tmp___4!=0,tmp___4!=2,tmp___4==0,tmp___4==2} @*/ tmp___4 ;
  int /*@  predicates{tmp___5!=0,tmp___5!=2,tmp___5==0,tmp___5==2} @*/ tmp___5 ;
  int /*@  predicates{tmp___6!=0,tmp___6!=2,tmp___6==0,tmp___6==2} @*/ tmp___6 ;
  int /*@  predicates{tmp___7==1024,tmp___7==512} @*/ tmp___7 ;
  long tmp___8 = __VERIFIER_nondet_long();
  int /*@  predicates{tmp___9!=0,tmp___9!=2,tmp___9==0,tmp___9==2} @*/ tmp___9 ;
  int /*@  predicates{tmp___10!=0,tmp___10!=2,tmp___10==0,tmp___10==2} @*/ tmp___10 ;
