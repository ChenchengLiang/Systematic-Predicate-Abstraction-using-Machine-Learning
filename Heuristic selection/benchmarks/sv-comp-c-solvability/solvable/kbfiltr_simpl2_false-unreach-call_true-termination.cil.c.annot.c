...
void errorFn(void);
void IofCompleteRequest(int /*@  predicates{Irp!=0,Irp!=1,Irp!=10,Irp!=11,Irp!=12,Irp!=13,Irp!=15,Irp!=16,Irp!=17,Irp!=18,Irp!=19,Irp!=2,Irp!=20,Irp!=23,Irp!=3,Irp!=4,Irp!=5,Irp!=6,Irp!=7,Irp!=8,Irp!=9,Irp==0,Irp==1,Irp==10,Irp==11,Irp==12,Irp==13,Irp==15,Irp==16,Irp==17,Irp==18,Irp==19,Irp==2,Irp==20,Irp==23,Irp==3,Irp==4,Irp==5,Irp==6,Irp==7,Irp==8,Irp==9} predicates_tpl{0==0} @*/ Irp , int /*@  predicates{PriorityBoost==0} @*/ PriorityBoost);
...
int main(void)
{ int /*@  predicates{(status!=(-1)),status!=259,status!=lowerDriverReturn,status<0,status==(-1),status==(-1073741757),status==(-1073741811),status==(-1073741822),status==(-1073741823),status==0,status==1,status==259,status>=0} @*/ status ;
