...
(assert (inv_main3 268435440 ) )
(assert (forall ((var0 Int)) (or (not (and (inv_main3 var0 ) (not (<= 0 (+ var0 (- 1) ) ) ) ) ) (inv_main4 var0 ) ) ) )
(assert (forall ((var0 Int)) (or (not (and (inv_main3 var0 ) (<= 0 (+ var0 (- 1) ) ) ) ) (inv_main3 (+ var0 (- 2) ) ) ) ) )
