...
char /*@  predicates{((((((st1+st2)+st3)+st4)+st5)+st6)<=1),((((((st1+st2)+st3)+st4)+st5)+st6)==1),st6!=(-1),st6!=0,st6==(-1),st6==0,st6==1} @*/ st6 ;
char send6 ;
int mode6 ;
int alive6 ;
void node1(void)
...
int main(void)
{
  ...
  int /*@  predicates{i2<12,i2<=12,i2==0,i2==1,i2>=0,i2>=1} @*/ i2 ;
