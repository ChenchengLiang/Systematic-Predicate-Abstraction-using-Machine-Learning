...
(assert (forall ((var0 Int)) (forall ((var1 Int)) (forall ((var2 Int)) (forall ((var3 Int)) (or (not (and (inv_main12 var3 var1 var2 var0 ) (and (not (<= 0 (+ var1 (- 1) ) ) ) (<= 0 (+ (+ var2 (* (- 1) var3 ) ) (- 1) ) ) ) ) ) (inv_main17 var3 var1 var2 var0 ) ) ) ) ) ) )
...
(assert (forall ((var0 Int)) (forall ((var1 Int)) (forall ((var2 Int)) (forall ((var3 Int)) (or (not (and (inv_main12 var3 var1 var2 var0 ) (and (<= 0 (+ var1 (- 1) ) ) (<= 0 (+ (+ var2 (* (- 1) var3 ) ) (- 1) ) ) ) ) ) (inv_main12 (+ var3 1 ) var1 var2 var0 ) ) ) ) ) ) )
