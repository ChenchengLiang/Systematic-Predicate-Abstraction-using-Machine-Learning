...
extern int __VERIFIER_nondet_int();
extern int __VERIFIER_nondet_int();
# 1 "MAP/SAFE-exbench/SVCOMP13-sshsimpl-s3_clnt_3il_safe.c.tmp.c"
# 1 "<command-line>"
# 1 "MAP/SAFE-exbench/SVCOMP13-sshsimpl-s3_clnt_3il_safe.c.tmp.c"
# 18 "MAP/SAFE-exbench/SVCOMP13-sshsimpl-s3_clnt_3il_safe.c.tmp.c"
//extern int __VERIFIER_nondet_int();
                                                                  ...
                                                                  if (s__state == 4352) {
                                                                    ...
                                                                    if (s__state == 3) {
                                                                      ...
                                                                      if (0) {
                                                                        ...
                                                                        s__type = 4096;
                                                                        if ((unsigned long )s__init_buf___0 == (unsigned long )(0)) {
                                                                          buf = __VERIFIER_nondet_int();
                                                                          if ((unsigned long )buf == (unsigned long )(0)) {
                                                                            ret = -1;
                                                                            goto end;
                                                                          } else {
