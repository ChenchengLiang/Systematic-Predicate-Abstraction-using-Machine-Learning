...
(assert (forall ((var0 Int)) (forall ((var1 Int)) (forall ((var2 Int)) (forall ((var3 Int)) (or (not (and (inv_main5 var0 var2 var3 ) (and (not (= var1 0 ) ) (not (= var3 var2 ) ) ) ) ) (inv_main5 0 var3 (+ var3 2 ) ) ) ) ) ) ) )
