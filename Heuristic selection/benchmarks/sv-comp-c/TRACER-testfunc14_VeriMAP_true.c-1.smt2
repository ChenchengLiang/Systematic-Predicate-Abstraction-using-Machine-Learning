...
(assert (forall ((var0 Int)) (forall ((var1 Int)) (forall ((var2 Int)) (forall ((var3 Int)) (or (not (and (inv_main3 var0 var2 ) (and (<= 0 (+ var1 (- 1) ) ) (not (<= 0 (+ var0 (- 1) ) ) ) ) ) ) (inv_main13 var0 3 0 var3 var1 4 ) ) ) ) ) ) )
(assert (forall ((var0 Int)) (forall ((var1 Int)) (forall ((var2 Int)) (forall ((var3 Int)) (or (not (and (inv_main3 var0 var3 ) (and (not (<= 0 (+ var1 (- 1) ) ) ) (not (<= 0 (+ var0 (- 1) ) ) ) ) ) ) (inv_main13 var0 3 0 var2 var1 5 ) ) ) ) ) ) )
