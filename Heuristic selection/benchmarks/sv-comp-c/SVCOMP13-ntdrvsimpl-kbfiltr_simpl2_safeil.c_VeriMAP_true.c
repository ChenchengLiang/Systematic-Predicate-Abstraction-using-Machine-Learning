...
extern int __VERIFIER_nondet_int();
extern int __VERIFIER_nondet_int();
# 1 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-kbfiltr_simpl2_safeil.c.tmp.c"
# 1 "<command-line>"
# 1 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-kbfiltr_simpl2_safeil.c.tmp.c"
# 18 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-kbfiltr_simpl2_safeil.c.tmp.c"
...
void stub_driver_init(void)
{
  ...
  {
# 52 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-kbfiltr_simpl2_safeil.c.tmp.c"
  s = NP;
# 53 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-kbfiltr_simpl2_safeil.c.tmp.c"
  pended = 0;
# 54 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-kbfiltr_simpl2_safeil.c.tmp.c"
  compFptr = 0;
# 55 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-kbfiltr_simpl2_safeil.c.tmp.c"
  compRegistered = 0;
# 56 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-kbfiltr_simpl2_safeil.c.tmp.c"
  lowerDriverReturn = 0;
# 57 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-kbfiltr_simpl2_safeil.c.tmp.c"
  setEventCalled = 0;
# 58 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-kbfiltr_simpl2_safeil.c.tmp.c"
  customIrp = 0;
# 59 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-kbfiltr_simpl2_safeil.c.tmp.c"
  return;
}
}
