...
{ int /*@  predicates{s__info_callback!=0,s__info_callback!=2,s__info_callback==0,s__info_callback==2} @*/ s__info_callback = __VERIFIER_nondet_int();
  ...
  int /*@  predicates{blastFlag==0,blastFlag==1,blastFlag==10,blastFlag==11,blastFlag==12,blastFlag==13,blastFlag==14,blastFlag==15,blastFlag==16,blastFlag==17,blastFlag==18,blastFlag==19,blastFlag==2,blastFlag==20,blastFlag==21,blastFlag==3,blastFlag==4,blastFlag==5,blastFlag==6,blastFlag==7,blastFlag==8,blastFlag==9} @*/ blastFlag ;
