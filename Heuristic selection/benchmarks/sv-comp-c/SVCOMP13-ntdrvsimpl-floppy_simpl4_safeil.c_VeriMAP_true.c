...
extern int __VERIFIER_nondet_int();
extern int __VERIFIER_nondet_int();
# 1 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
# 1 "<command-line>"
# 1 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
# 18 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
...
void _BLAST_init(void)
{
  ...
  {
# 75 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
  UNLOADED = 0;
# 76 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
  NP = 1;
# 77 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
  DC = 2;
# 78 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
  SKIP1 = 3;
# 79 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
  SKIP2 = 4;
# 80 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
  MPR1 = 5;
# 81 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
  MPR3 = 6;
# 82 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
  IPC = 7;
# 83 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
  s = UNLOADED;
# 84 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
  pended = 0;
# 85 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
  compRegistered = 0;
# 86 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
  lowerDriverReturn = 0;
# 87 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
  setEventCalled = 0;
# 88 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
  customIrp = 0;
# 89 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_safeil.c.tmp.c"
  return;
}
}
