...
extern int __VERIFIER_nondet_int();
extern int __VERIFIER_nondet_int();
# 1 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
# 1 "<command-line>"
# 1 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
# 18 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
...
void _BLAST_init(void)
{
  ...
  {
# 75 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
  UNLOADED = 0;
# 76 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
  NP = 1;
# 77 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
  DC = 2;
# 78 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
  SKIP1 = 3;
# 79 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
  SKIP2 = 4;
# 80 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
  MPR1 = 5;
# 81 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
  MPR3 = 6;
# 82 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
  IPC = 7;
# 83 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
  s = UNLOADED;
# 84 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
  pended = 0;
# 85 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
  compRegistered = 0;
# 86 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
  lowerDriverReturn = 0;
# 87 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
  setEventCalled = 0;
# 88 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
  customIrp = 0;
# 89 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl4_unsafeil.c.tmp.c"
  return;
}
}
