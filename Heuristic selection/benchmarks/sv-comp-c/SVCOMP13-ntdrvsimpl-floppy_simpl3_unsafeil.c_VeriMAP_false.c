...
extern int __VERIFIER_nondet_int();
extern int __VERIFIER_nondet_int();
# 1 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
# 1 "<command-line>"
# 1 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
# 18 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
...
void _BLAST_init(void)
{
  ...
  {
# 73 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
  UNLOADED = 0;
# 74 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
  NP = 1;
# 75 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
  DC = 2;
# 76 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
  SKIP1 = 3;
# 77 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
  SKIP2 = 4;
# 78 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
  MPR1 = 5;
# 79 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
  MPR3 = 6;
# 80 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
  IPC = 7;
# 81 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
  s = UNLOADED;
# 82 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
  pended = 0;
# 83 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
  compRegistered = 0;
# 84 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
  lowerDriverReturn = 0;
# 85 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
  setEventCalled = 0;
# 86 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
  customIrp = 0;
# 87 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-floppy_simpl3_unsafeil.c.tmp.c"
  return;
}
}
