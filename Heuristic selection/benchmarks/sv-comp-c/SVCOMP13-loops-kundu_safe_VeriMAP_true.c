...
extern int __VERIFIER_nondet_int();
extern int __VERIFIER_nondet_int();
# 1 "MAP/SAFE-exbench/SVCOMP13-loops-kundu_safe.tmp.c"
# 1 "<command-line>"
# 1 "MAP/SAFE-exbench/SVCOMP13-loops-kundu_safe.tmp.c"
# 18 "MAP/SAFE-exbench/SVCOMP13-loops-kundu_safe.tmp.c"
//extern int __VERIFIER_nondet_int();
...
int max_loop ;
int clk ;
int /*@ predicates{num==0,num==1} @*/ num ;
int i ;
int e ;
int timer ;
char data_0 ;
...
int P_2_i ;
int /*@ predicates{P_1_ev == 1,P_2_ev==2} @*/ P_2_ev ;
void P_2(void)
{
