...
extern int __VERIFIER_nondet_int();
extern int __VERIFIER_nondet_int();
# 1 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-cdaudio_simpl1_safeil.c.tmp.c"
# 1 "<command-line>"
# 1 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-cdaudio_simpl1_safeil.c.tmp.c"
# 18 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-cdaudio_simpl1_safeil.c.tmp.c"
...
/* void errorFn(void)
{
  ...
  goto ERROR;
  ERROR: assert(0);
# 60 "MAP/SAFE-exbench/SVCOMP13-ntdrvsimpl-cdaudio_simpl1_safeil.c.tmp.c"
  return;
}
}
*/
