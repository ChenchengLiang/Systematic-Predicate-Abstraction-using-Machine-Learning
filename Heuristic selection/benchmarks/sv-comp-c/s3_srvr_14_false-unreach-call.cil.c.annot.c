...
{ int /*@  predicates{s__info_callback!=(-12288),s__info_callback!=(-16384),s__info_callback!=0,s__info_callback!=2,s__info_callback==(-12288),s__info_callback==(-16384),s__info_callback==0,s__info_callback==2} @*/ s__info_callback = __VERIFIER_nondet_int();
  int s__in_handshake = __VERIFIER_nondet_int();
  int /*@  predicates{s__state!=12292,s__state!=8656,s__state==12292,s__state==16384,s__state==24576,s__state==3,s__state==8192,s__state==8195,s__state==8448,s__state==8464,s__state==8465,s__state==8466,s__state==8480,s__state==8481,s__state==8482,s__state==8496,s__state==8497,s__state==8512,s__state==8513,s__state==8528,s__state==8529,s__state==8544,s__state==8545,s__state==8560,s__state==8561,s__state==8576,s__state==8577,s__state==8592,s__state==8593,s__state==8608,s__state==8609,s__state==8640,s__state==8641,s__state==8656,s__state==8657,s__state==8672,s__state==8673} @*/ s__state ;
  int /*@  predicates{s__new_session==0,s__new_session==1} @*/ s__new_session ;
  int /*@  predicates{s__server==1} @*/ s__server ;
  int /*@  predicates{s__version!=(-12288),s__version!=(-16384),s__version!=0,s__version!=2,s__version==(-12288),s__version==(-16384),s__version==0,s__version==2} @*/ s__version = __VERIFIER_nondet_int();
  int /*@  predicates{s__type==8192} @*/ s__type ;
  int /*@  predicates{s__init_num==0} @*/ s__init_num ;
  int /*@  predicates{s__hit!=(-12288),s__hit!=(-16384),s__hit!=0,s__hit!=2,s__hit==(-12288),s__hit==(-16384),s__hit==0,s__hit==2} @*/ s__hit = __VERIFIER_nondet_int();
  int /*@  predicates{s__rwstate==1,s__rwstate==2} @*/ s__rwstate ;
  int /*@  predicates{s__init_buf___0!=(-12288),s__init_buf___0!=(-16384),s__init_buf___0!=0,s__init_buf___0!=2,s__init_buf___0==(-12288),s__init_buf___0==(-16384),s__init_buf___0==0,s__init_buf___0==2} @*/ s__init_buf___0 ;
  int /*@  predicates{s__debug!=(-12288),s__debug!=(-16384),s__debug!=0,s__debug!=2,s__debug==(-12288),s__debug==(-16384),s__debug==0,s__debug==2} @*/ s__debug = __VERIFIER_nondet_int();
  int /*@  predicates{s__shutdown==0} @*/ s__shutdown ;
  int /*@  predicates{s__cert!=(-12288),s__cert!=(-16384),s__cert!=0,s__cert!=2,s__cert==(-12288),s__cert==(-16384),s__cert==0,s__cert==2} @*/ s__cert = __VERIFIER_nondet_int();
  int /*@  predicates{s__options!=(-12288),s__options!=(-16384),s__options!=0,s__options!=2,s__options==(-12288),s__options==(-16384),s__options==0,s__options==2} @*/ s__options = __VERIFIER_nondet_int();
  int /*@  predicates{s__verify_mode!=(-12288),s__verify_mode!=(-16384),s__verify_mode!=0,s__verify_mode!=2,s__verify_mode+1,s__verify_mode+2,s__verify_mode+4,s__verify_mode==(-12288),s__verify_mode==(-16384),s__verify_mode==0,s__verify_mode==2} @*/ s__verify_mode = __VERIFIER_nondet_int();
  int /*@  predicates{s__session__peer!=(-12288),s__session__peer!=(-16384),s__session__peer!=0,s__session__peer!=2,s__session__peer==(-12288),s__session__peer==(-16384),s__session__peer==0,s__session__peer==2} @*/ s__session__peer = __VERIFIER_nondet_int();
  int /*@  predicates{s__cert__pkeys__AT0__privatekey!=(-12288),s__cert__pkeys__AT0__privatekey!=(-16384),s__cert__pkeys__AT0__privatekey!=0,s__cert__pkeys__AT0__privatekey!=2,s__cert__pkeys__AT0__privatekey==(-12288),s__cert__pkeys__AT0__privatekey==(-16384),s__cert__pkeys__AT0__privatekey==0,s__cert__pkeys__AT0__privatekey==2} @*/ s__cert__pkeys__AT0__privatekey = __VERIFIER_nondet_int();
  int /*@  predicates{s__ctx__info_callback!=(-12288),s__ctx__info_callback!=(-16384),s__ctx__info_callback!=0,s__ctx__info_callback!=2,s__ctx__info_callback==(-12288),s__ctx__info_callback==(-16384),s__ctx__info_callback==0,s__ctx__info_callback==2} @*/ s__ctx__info_callback = __VERIFIER_nondet_int();
  ...
  int /*@  predicates{s__s3__tmp__reuse_message!=0,s__s3__tmp__reuse_message==0} @*/ s__s3__tmp__reuse_message ;
  int /*@  predicates{s__s3__tmp__use_rsa_tmp!=0,s__s3__tmp__use_rsa_tmp==0,s__s3__tmp__use_rsa_tmp==1} @*/ s__s3__tmp__use_rsa_tmp ;
  int /*@  predicates{s__s3__tmp__new_cipher!=(-12288),s__s3__tmp__new_cipher!=(-16384),s__s3__tmp__new_cipher!=0,s__s3__tmp__new_cipher!=2,s__s3__tmp__new_cipher==(-12288),s__s3__tmp__new_cipher==(-16384),s__s3__tmp__new_cipher==0,s__s3__tmp__new_cipher==2} @*/ s__s3__tmp__new_cipher = __VERIFIER_nondet_int();
  int /*@  predicates{s__s3__tmp__new_cipher__algorithms!=(-12288),s__s3__tmp__new_cipher__algorithms!=(-16384),s__s3__tmp__new_cipher__algorithms!=0,s__s3__tmp__new_cipher__algorithms!=2,s__s3__tmp__new_cipher__algorithms==(-12288),s__s3__tmp__new_cipher__algorithms==(-16384),s__s3__tmp__new_cipher__algorithms==0,s__s3__tmp__new_cipher__algorithms==2} @*/ s__s3__tmp__new_cipher__algorithms = __VERIFIER_nondet_int();
  ...
  int /*@  predicates{s__s3__tmp__new_cipher__algo_strength!=(-12288),s__s3__tmp__new_cipher__algo_strength!=(-16384),s__s3__tmp__new_cipher__algo_strength!=0,s__s3__tmp__new_cipher__algo_strength!=2,s__s3__tmp__new_cipher__algo_strength==(-12288),s__s3__tmp__new_cipher__algo_strength==(-16384),s__s3__tmp__new_cipher__algo_strength==0,s__s3__tmp__new_cipher__algo_strength==2} @*/ s__s3__tmp__new_cipher__algo_strength = __VERIFIER_nondet_int();
  int /*@  predicates{s__session__cipher!=(-12288),s__session__cipher!=(-16384),s__session__cipher!=0,s__session__cipher!=2,s__session__cipher==(-12288),s__session__cipher==(-16384),s__session__cipher==0,s__session__cipher==2,s__session__cipher==s__s3__tmp__new_cipher} @*/ s__session__cipher ;
  int /*@  predicates{buf!=(-12288),buf!=(-16384),buf!=0,buf!=2,buf==(-12288),buf==(-16384),buf==0,buf==2,buf==s__init_buf___0} @*/ buf ;
  unsigned long l ;
  unsigned long Time ;
  unsigned long tmp ;
  int /*@  predicates{cb!=(-12288),cb!=(-16384),cb!=0,cb!=2,cb==(-12288),cb==(-16384),cb==0,cb==2,cb==s__ctx__info_callback,cb==s__info_callback} @*/ cb ;
  long num1 ;
  int /*@  predicates{ret!=(-12288),ret!=(-16384),ret!=0,ret!=2,ret<=0,ret==(-1),ret==(-12288),ret==(-16384),ret==0,ret==1,ret==2} @*/ ret ;
  ...
  int /*@  predicates{(tmp___1!=(-12288)),tmp___1!=(-12288),tmp___1!=(-16384),tmp___1!=0,tmp___1!=2,tmp___1==(-12288),tmp___1==(-16384),tmp___1==0,tmp___1==2} @*/ tmp___1 = __VERIFIER_nondet_int();
  int /*@  predicates{(tmp___2!=(-16384)),tmp___2!=(-12288),tmp___2!=(-16384),tmp___2!=0,tmp___2!=2,tmp___2==(-12288),tmp___2==(-16384),tmp___2==0,tmp___2==2} @*/ tmp___2 = __VERIFIER_nondet_int();
  int /*@  predicates{tmp___3!=(-12288),tmp___3!=(-16384),tmp___3!=0,tmp___3!=2,tmp___3==(-12288),tmp___3==(-16384),tmp___3==0,tmp___3==2} @*/ tmp___3 = __VERIFIER_nondet_int();
  int /*@  predicates{tmp___4!=(-12288),tmp___4!=(-16384),tmp___4!=0,tmp___4!=2,tmp___4==(-12288),tmp___4==(-16384),tmp___4==0,tmp___4==2} @*/ tmp___4 = __VERIFIER_nondet_int();
  int /*@  predicates{tmp___5!=(-12288),tmp___5!=(-16384),tmp___5!=0,tmp___5!=2,tmp___5==(-12288),tmp___5==(-16384),tmp___5==0,tmp___5==2} @*/ tmp___5 = __VERIFIER_nondet_int();
  int /*@  predicates{tmp___6!=(-12288),tmp___6!=(-16384),tmp___6!=0,tmp___6!=2,tmp___6==(-12288),tmp___6==(-16384),tmp___6==0,tmp___6==2} @*/ tmp___6 = __VERIFIER_nondet_int();
  int /*@  predicates{tmp___7==1024,tmp___7==512} @*/ tmp___7 ;
  long tmp___8 = __VERIFIER_nondet_long();
  int /*@  predicates{tmp___9!=(-12288),tmp___9!=(-16384),tmp___9!=0,tmp___9!=2,tmp___9==(-12288),tmp___9==(-16384),tmp___9==0,tmp___9==2} @*/ tmp___9 = __VERIFIER_nondet_int();
  int /*@  predicates{tmp___10!=(-12288),tmp___10!=(-16384),tmp___10!=0,tmp___10!=2,tmp___10==(-12288),tmp___10==(-16384),tmp___10==0,tmp___10==2} @*/ tmp___10 = __VERIFIER_nondet_int();
  int /*@  predicates{blastFlag==0,blastFlag==1,blastFlag==10,blastFlag==2,blastFlag==3,blastFlag==4,blastFlag==5,blastFlag==6,blastFlag==7,blastFlag==8,blastFlag==9} @*/ blastFlag ;
...
{ int /*@  predicates{s==12292,s==16384,s==24576,s==3,s==8192,s==8195,s==8448,s==8464,s==8465,s==8466,s==8480,s==8481,s==8482,s==8496,s==8497,s==8512,s==8513,s==8528,s==8529,s==8544,s==8545,s==8560,s==8561,s==8576,s==8577,s==8592,s==8593,s==8608,s==8609,s==8640,s==8641,s==8656,s==8657,s==8672,s==8673} @*/ s ;
  int /*@  predicates{tmp!=(-12288),tmp!=(-16384),tmp!=0,tmp!=2,tmp==(-1),tmp==(-12288),tmp==(-16384),tmp==0,tmp==1,tmp==2} @*/ tmp ;
