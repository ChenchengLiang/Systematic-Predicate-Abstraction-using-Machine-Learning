...
(assert (forall ((var0 Int)) (forall ((var1 Int)) (forall ((var2 Int)) (forall ((var3 Int)) (forall ((var4 Int)) (forall ((var5 Int)) (forall ((var6 Int)) (forall ((var7 Int)) (not (and (inv_main16 var5 var1 var6 var3 var2 var7 var4 var0 ) (and (and (not (= var5 0 ) ) (not (= var1 0 ) ) ) (not (= var6 0 ) ) ) ) ) ) ) ) ) ) ) ) ) )
(check-sat)
