...
extern int __VERIFIER_nondet_int();
extern int __VERIFIER_nondet_int();
# 1 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-cdaudio_simpl1_unsafeil.c.tmp.c"
# 1 "<command-line>"
# 1 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-cdaudio_simpl1_unsafeil.c.tmp.c"
# 18 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-cdaudio_simpl1_unsafeil.c.tmp.c"
...
/* void errorFn(void)
{
  ...
  goto ERROR;
  ERROR: assert(0);
# 60 "MAP/UNSAFE-exbench/SVCOMP13-ntdrvsimpl-cdaudio_simpl1_unsafeil.c.tmp.c"
  return;
}
}
*/
