...
int /*@  predicates{fast_clk_edge==1} predicates_tpl{0==0} @*/ fast_clk_edge ;
int /*@  predicates{slow_clk_edge==1} @*/ slow_clk_edge ;
int q_buf_0 ;
...
int p_num_write ;
int /*@  predicates{p_last_write==q_buf_0} @*/ p_last_write ;
int /*@  predicates{p_dw_st==0,p_dw_st==2} @*/ p_dw_st ;
int /*@  predicates{p_dw_pc==0,p_dw_pc==1,p_dw_pc==2} @*/ p_dw_pc ;
int /*@  predicates{p_dw_i==1} @*/ p_dw_i ;
int /*@  predicates{c_num_read==p_num_write} @*/ c_num_read ;
int /*@  predicates{c_last_read==p_last_write,c_last_read==q_buf_0} @*/ c_last_read ;
int /*@  predicates{c_dr_st==0,c_dr_st==2} @*/ c_dr_st ;
int /*@  predicates{c_dr_pc==0,c_dr_pc==1,c_dr_pc==2} @*/ c_dr_pc ;
...
static int /*@  predicates{a_t==q_buf_0} @*/ a_t ;
void do_read_c(void)
{ int /*@  predicates{a==q_buf_0} @*/ a ;
