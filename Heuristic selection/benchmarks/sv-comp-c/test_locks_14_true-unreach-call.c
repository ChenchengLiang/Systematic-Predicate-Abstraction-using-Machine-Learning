...
int main()
{
    ...
    int /*@ predicates_tpl{p1==0||lk1==1,p2==0||lk2==1,p3==0||lk3==1,
		p4==0||lk4==1,p5==0||lk5==1,p6==0||lk6==1,p7==0||lk7==1,
		p8==0||lk8==1,p9==0||lk9==1,p10==0||lk10==1,
		p11==0||lk11==1,p12==0||lk12==1,
		p13==0||lk13==1,p14==0||lk14==1} @*/ lk14; // lock variable
