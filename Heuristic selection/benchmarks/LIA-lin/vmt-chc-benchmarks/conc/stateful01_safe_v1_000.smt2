...
(assert
  ...
  (and (= (and (not W) (not L) (not K)) (and (not V) (not U) (not T)))
       ...
       (or (not C) D E (and W (not L) K) (and K1 J1 (not W) (not L) K))
       (or C (not D) (not E) (and W (not L) K) (and (not K1) J1 I1 L K))
       (or (not A) B R1 (and X (not G) F) a!3)
       (or A (not B) R1 (and X (not G) F) a!4)
       (or A
           B
           R1
           (and X (not G) F)
       ...
       (or (not A) (not B) R1 (and X (not G) F) (and (not H1) G1 F1 G F))
       (or P
           (not O)
           (and S (not P) (not O))
       ...
       (or (not P) O (and S (not P) (not O)) (and (not R) (not Q) M1))
       (or (not S) P O (and (= N1 I) (= L1 R) (= M1 Q)))
       (or U
           (not T)
           (and V (not U) (not T))
       ...
       (or (not U) T (and (not Z) (not Y) O1) (and V (not U) (not T)))
       (or (not V) U T (and (= Q1 A1) (= O1 Y) (= P1 Z)))
       (or W L K (= Q1 E1))
       (or W L (not K) (= D1 A1))
       (or (not W) L (not K) (and (= M N) (= D1 E1) (= C J1) (= D I1) (= E K1)))
       (or X G F (= Q1 B1))
       (or X G (not F) (= C1 A1))
       (or (not X)
           G
