  ...
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Bool) (F Bool) (G Bool) (H Bool) (I Bool) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Int) (S Bool) (T Bool) (U Bool) ) 
    (=>
      ...
      (a!15 (and (not I)
                 ...
                 (= O N)
                 (= Q P))))
  (and (or A (not B) (not C) S (not T) U a!1 (<= 0 K))
       (or (not A) (not B) (not C) S (not T) U a!2 (<= 0 O))
       (or A (not B) C S (not T) (not U) a!3 (<= 1 (+ K M O)))
       a!4
       (or (not A)
           (not B)
           (not C)
       ...
       (or A
           ...
           (and I
                ...
                (= Q P))
           (= R 0))
       (or A (not B) C S (not T) U a!5 (<= 0 M))
       (or (not A)
           (not B)
           C
           S
       ...
       (or A
           ...
           (and (not I)
                ...
                (= Q P))
           (not (= R 0)))
       (or (not A) (not B) (not C) S T U a!6 (not (<= 1 O)))
       (or (not A)
           (not B)
           (not C)
           S
       ...
       (or A
           ...
           (and (not I)
                ...
                (= Q P))
           (= M 0))
       (or A B C (not S) T U a!8)
       (or (not A) B (not C) (not S) T U a!9)
       (or (not A) (not B) (not C) (not S) T (not U) a!10)
       (or A (not B) (not C) (not S) T U a!11)
       (or (not A) (not B) (not C) S T (not U) a!12)
       (or A (not B) (not C) S T (not U) a!13)
       (or (not A) (not B) (not C) S (not T) (not U) a!14)
       (or (not A) B (not C) S (not T) (not U) a!1)
       (or A (not B) (not C) S (not T) (not U) a!2)
       (or A B (not C) S (not T) (not U) a!3)
       (or (not A)
           B
           C
           S
       ...
       (or A B (not C) S T U a!15)
       (or A B (not C) S T (not U) a!15)
       (or A B (not C) (not S) T U a!15)
       (or (not A) B C S T U a!15)
       (or (not A) B (not C) S T U a!15)
       (or (not A) (not B) C S (not T) (not U) a!15)
       (or (not A) (not B) C (not S) T (not U) a!15)
       (or A
           B
           (not C)
           (not S)
       ...
       (or (not A) (not B) C S (not T) U a!14 (<= 0 Q))))
      )
