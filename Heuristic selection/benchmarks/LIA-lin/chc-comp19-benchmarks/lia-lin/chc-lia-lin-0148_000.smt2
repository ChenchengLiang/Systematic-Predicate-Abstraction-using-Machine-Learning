      ...
      (and
        (let ((a!1 (= (or (and (not C)
                  ...
                  (and C
                       ...
                       (not J)))
              K))
      (a!2 (= (or (not V) (not (<= 2 X))) A1))
      (a!3 (= A (and K (not (<= 5 L2)) (<= 0 L2)))))
  (and (= T U)
       (= S Y)
       (= R 0)
       (= R S)
    ...
    (=>
      ...
      (a!2 (= (or (and (not A3)
                  ...
                  (and A3
                       ...
                       (not H3)))
              I3))
      (a!3 (= (or (not V) (not (<= 2 X))) A1))
      (a!4 (= (or (not T3) (not (<= 2 V3))) Y3))
      (a!5 (and (<= 1 U) (= O 0) (= Q 0) (= S 0)))
      (a!6 (= (and (<= 1 U) (<= 1 (+ O Q))) Q5))
      (a!7 (= L5 (and (<= 1 U) (<= 1 (+ O Q)))))
      (a!8 (= Z2 (and I3 B (not (<= 5 J5)) (<= 0 J5))))
      (a!9 (or (not Q5) (= (+ O (* (- 1) Q) (* (- 1) U4)) (- 2))))
      (a!10 (or (not Q5) (= (+ U (* (- 1) X4)) 1)))
      (a!11 (or (not P5) (= (+ S (* (- 1) R4)) (- 1))))
      (a!12 (or (not P5) (= (+ Q (* (- 1) Q4)) 1)))
      (a!13 (or (not O5) (= (+ Q (* (- 1) M4)) (- 1))))
      (a!14 (or (not S5) (= (+ U (* (- 1) B5)) 1)))
      (a!15 (or (not S5) (= (+ Q (* (- 1) A5)) (- 1))))
      (a!16 (or (not R5) (= (+ U (* (- 1) I5)) 1)))
      (a!17 (or (not R5) (= (+ S (* (- 1) H5)) 1)))
      (a!18 (or (not R5) (= (+ O (* (- 1) F5)) (- 2))))
      (a!19 (or (not N5) (= (+ U (* (- 1) I4)) 1)))
      (a!20 (or (not M5) (= (+ U (* (- 1) C4)) 1)))
      (a!21 (or (not M5) (= (+ S (* (- 1) U5)) 1)))
      (a!22 (or (not M5) (= (+ O (* (- 1) B4)) (- 2))))
      (a!23 (or (not L5) (= (+ O Q (* (- 1) T5)) (- 1))))
      (a!24 (or (not L5) (= (+ U (* (- 1) V5)) 1))))
  (and (= T U)
       (= S Y)
       (= R S)
       (= Q X)
