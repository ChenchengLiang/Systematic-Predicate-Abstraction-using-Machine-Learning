...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) ) 
    (=>
      (and
        (h1 C D E F G H A I J K)
        (= A B)
      )
      (h2 C D E F G H A B J K)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) ) 
    (=>
      (and
        (h3 C D E F G A B H I J)
        (<= (+ A (* (- 1) B)) (- 1))
      )
      (h6 C D E F G A B H I J)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) ) 
    (=>
      (and
        (h17 B C D E F A G H I J)
        (>= A 1)
      )
      (h22 B C D E F A G H I J)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) ) 
    (=>
      (and
        (h22 D E F G H A B I J K)
        (= A (+ (* (- 1) B) C))
      )
      (h23 D E F G H A C I J K)
    )
  )
)
(assert
